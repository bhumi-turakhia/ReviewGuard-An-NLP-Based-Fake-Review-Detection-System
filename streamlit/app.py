...
# Footer
st.markdown("---")
st.markdown("Made by Team ReviewGuard | [Full Stack Version](https://github.com/bhumi-turakhia/ReviewGuard-An-NLP-Based-Fake-Review-Detection-System) | Models trained on 8000+ reviews")
